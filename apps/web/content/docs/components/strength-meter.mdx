...
<p className="md:text-sm -mt-8 text-gray-700 dark:text-gray-300 max-w-3xl">
  Install the Password Strength Meter component using your preferred package
  manager.
</p>
...
<p className="md:text-sm mb-4! text-gray-700 dark:text-gray-300 max-w-3xl">
  The Password Strength Meter component is packed with powerful features
