...
<Tabs items={["Web", "React Native"]}>
  ...
  <Tabs items={["Preview", "Code"]}>
    ...
    <Tab value="Code">
      ```tsx title="file-uploader-demo.tsx"
import {
        FileUploader,
...
<Tab value="React Native">
  ...
  ### Configure Vector Icons [!toc]

  Follow the setup guide for @react-native-vector-icons/ant-design to configure vector icons in your project according to the [React Native Vector Icons documentation](https://github.com/oblador/react-native-vector-icons).
