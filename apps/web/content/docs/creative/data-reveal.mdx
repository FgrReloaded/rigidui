...
<Tabs items={["Preview", "Code"]}>
  ...
  <Tab value="Code">
    ```tsx title="data-reveal-demo.tsx"
"use client";
            ...
            <div className="space-y-6">
                <DataReveal>
                    ...
                    <RevealContainer className="gap-2">
                        <RevealItem content="john@example.com" index={0} />
                        <RevealItem content="+1 234-567-8900" index={1} />
                        <RevealItem content="#12345" index={2} />
                    </RevealContainer>
                </DataReveal>
            </div>
        );
...
<TypeTable
  type={{
    ...
    autoHideDelay: {
      description: 'Delay in milliseconds before auto-hiding (when autoHide is true)',
      type: 'number',
      default: '3000',
    },
  }}
