...
const Sidebar = () => {
  ...
  return (
    <div style={navFont.style} className="fixed top-1.5 left-0 w-screen h-16 bg-transparent z-50 flex gap-2 items-center justify-center">
      ...
      <div className="h-full sm:w-[80vw] bg-transparent backdrop-blur-lg rounded-lg flex items-center justify-center px-8 relative overflow-hidden shadow-light dark:shadow-none">
        ...
        <nav className="flex items-center lg:gap-6 relative z-10">
          <Link href="/" className="flex items-center lg:gap-3 gap-1.5 sm:px-4 px-3 py-2.5 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/30 transition-all duration-200 group border border-transparent hover:border-blue-100 dark:hover:border-blue-800 hover:shadow-sm dark:hover:shadow-blue-900/20">
